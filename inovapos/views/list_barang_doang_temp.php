            ...
            <table id="myTable" class="tablesorter">
            	<thead>
                    <tr>
                        ...
                        <th style="width:13%;text-align:center;">Group</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    <tr>
                        ...
                        <td><a href="<?php 
                                        echo ($rowbarang->group_hp!='-1') ? 
                                            "javascript:tempel('$rowbarang->barang_kd','$rowbarang->barang_group','$rowbarang->barang_nm','$saldo','$rowbarang->barang_harga_jual','','','$rowbarang->group_kd','$rowbarang->group_hp','$rowbarang->group_elektrik','$rowbarang->barang_satuan')" : 
...
<script type="text/javascript">
    ...
    function tempel(kd,grup,nm,stok,hrg,qty,imei,grup,hp,el,sat)
    {
        if(hrg <= 0)
        {
            alert("Harga Kosong!");
        ...
        else
        {
            if (window.opener && !window.opener.closed)
            {
                ...
                else if(hp=='0'&&el=='1')
                {
                    ...
                    window.opener.$('#barang_harga').val('0');
                    window.opener.$('#barang_satuan').val(sat);
