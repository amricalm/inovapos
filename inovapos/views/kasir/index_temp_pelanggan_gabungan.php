...
<form action="<?php echo base_url() ?>index.php/kasir/simpan/" method="POST" name="frmKasir" id="frmKasir">
        ...
        <div class="grid_12">       
                <table style="width:100%;padding:0">
                    ...
                    <tr>
                        ...
                        <td>No. HP</td>
                        <td><input type="text" name="no_hp" id="no_hp" class="qty100 input-long " disabled="disabled" /></td>
    ...
    <div id="form-bayar" title="Kasir : <?php echo $this->session->userdata('user_nm') ?> | <?php echo $this->adntgl->tgl_panjang(date('Y-m-d')); ?>">
        <table>
            <tr>
                <td style="width: 200px;padding:5px"><?php echo form_checkbox('cbxpelanggan',1,false,'id="cbxpelanggan"'); ?> Pelanggan</td>
                <td><input type="text" class="" id="idpelanggan" name="idpelanggan" style="padding:5px;text-align:right;font-size:20px" disabled="disabled"/></td>
                <td></td>
            </tr>
            <tr>
                <td colspan="3"><div id="datapelanggan"></div></td>
            </tr>
            <tr>
                <td colspan="3"><hr /></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="input" class="qty100 angka" id="bayar_diskon" name="bayar_diskon" style="padding:5px;text-align:right;font-size:20px;width:50px;"/><input type="input" class="angka" id="bayar_diskon_display" style="padding:5px;text-align:right;font-size:20px;width:140px;" disabled="disabled"/></td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 200px;padding:5px">Total D/K</td>
                <td><?php echo form_input('total_dk','','style="padding:5px;text-align:right;font-size:20px" class="angka" disabled=disabled value=0 class="text ui-widget-content ui-corner-all" id="total_dk" '); ?></td>
                <td></td>
            </tr>
            <tr>
...
//    if($(this).is(':checked'))
//    {
//        $('#kdPelanggan').removeAttr('disabled');
//    }
//    else
//    {
//        $('#kdPelanggan').attr('disabled','disabled');
//    }
//})
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        else
        {
            ...
            if(imei == '')
            {
                if(pisahin[6]=='1' && pisahin[7]=='0')
                {
                    alert('Tekan F2 untuk memilih IMEI');
                    $('#barang_kd').focus();   
                }
                else if(pisahin[6]=='0' && pisahin[7]=='1')
                {
                    $('#qty').val('1');
...
function SimpanKasirBaru()
{
    ...
    else
    {
        ...
        //alert(totalBelanja);alert(biayaKartu);alert(jmhKredit);alert(jmhDebet);return;
        //$('#hasil').html(hasil);
