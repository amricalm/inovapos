...
function hitung_biaya_kartu()
{
    ...
    else if($('#term_kredit').is(':checked'))
    {
        ...
        var tot = convert_to_string($('#bayar_total').val());
        var biaya_kartu = (30/100)*parseFloat(tot);
...
function SimpanKasirBaru()
{
    ...
    var biayaKartu = convert_to_string($('#biaya_kartu').val());
...
//    {
        ...
        //alert(json);return;             
        $.post(
            base_url+'index.php/kasir/simpan_temp',
            {data:json},
            function(res)
            {
                //alert(res);return;
        ...
        .error(function() { alert("Ada Error di Transaction.\nHubungi Admin/Bagian IT!.");window.location = window.location; });
    //}
    return false; 
}
function frmbayar()
