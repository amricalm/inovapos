...
class App_model extends CI_Model
{
    ...
    function general()
    {
        ...
        $this->global['nama_printer']       = ($this->system('nama_printer')!='')?$this->system('nama_printer'):'doPDF 10';
        ...
        $this->global['port_cd']            = 'doPDF10';                                               /* PORT untuk CUSTOMER DISPLAY */
        ...
        switch($no)
        {
            case 'besar' :
                $menu                       = array(
                                            ...
                                            2   => array('nama'=>'Barang','link'=>base_url().'index.php/barang','ikon'=>'','extra'=>'','detail'=>array(
                                                ...
                                                2   => array('nama'=>'Group Barang','link'=>base_url().'index.php/group_barang/daftar','ikon'=>'','extra'=>'')
                                            ...
                                            4   => array('nama'=>'Stok','link'=>'#','ikon'=>'','extra'=>'','detail'=>array(
                                            ...
                                            5   => array('nama'=>'Pembelian','link'=>base_url().'index.php/pembelian/pembelian_temp?iframe=true&amp;width=100%&amp;height=100%','ikon'=>'','extra'=>'id="kasir" rel="prettyPhoto[iframe]"','detail'=>array()),
            ...
            case 'ikon' :
                $menu                       = array(
                                            ...
                                            // 3   => array('nama'=>'Keamanan','link'=>base_url().'index.php/user/daftar','ikon'=>'kunci.png','extra'=>''),
                                            3   => array('nama'=>'Penjualan','link'=>base_url().'index.php/laporan/penjualan','ikon'=>'Crystal_Clear_files.gif','extra'=>''),
