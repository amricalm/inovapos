...
class Pembelian_model extends CI_Model
{
    ...
    {
        return $this->db->insert('ac_tbeli',$data);
    }
    function simpan_dtl($data)
    {
        return $this->db->insert('ac_tbeli_dtl',$data);   
    }
    ...
    function cek_faktur_pembelian($no)
    {
        $this->db->where('no_faktur',$no);
        $this->db->select('no_faktur');
        return $this->db->get('ac_tbeli');
